...
# --- ESTA É A VERSÃO CORRETA E ROBUSTA DO PARSER ---
def parse_args(args_str):
    ...
    # Itera sobre as chaves de trás para frente para evitar problemas com palavras-chave nos comentários
    ...
    # O que sobra no início da string, antes da primeira chave, é o nome
